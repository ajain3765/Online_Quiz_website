<?php
  ...
  {
    if(@$_GET['demail'] && $_SESSION['key']=='admin1') 
    {
      $demail=@$_GET['demail'];
      $r1 = mysqli_query($con,"DELETE FROM rank WHERE email='$demail' ") or die('Error');
      $r2 = mysqli_query($con,"DELETE FROM history WHERE email='$demail' ") or die('Error');
      $result = mysqli_query($con,"DELETE FROM user WHERE email='$demail' ") or die('Error');
      header("location:welcome_admin.php?q=1");
    }
  }
  if(isset($_SESSION['key']))
  {
    ...
    {
      $demail=@$_GET['femail'];
	  $r= mysqli_query($con,"SELECT * FROM quiz_admin WHERE quizadmin='$demail' ") or die('Error');
	   while($row = mysqli_fetch_array($r)) 
      {
        $id = $row['id'];
		$result1 = mysqli_query($con,"DELETE FROM quiz WHERE eid ='$id' ") or die('Error');
	  }
